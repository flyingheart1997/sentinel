...
export class PanelLayoutManager implements AppModule {
  ...
  renderLayout(): void {
    this.ctx.container.innerHTML = `
      <div class="header cy-panel-header">
        ...
        return `
          ...
          <a href="https://x.com/koushikm_mondal" target="_blank" rel="noopener" class="credit-link">
            ...
            <span class="credit-text">@koushik</span>
          </a>
          <a href="https://github.com/flyingheart1997" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
        ...
        <div class="header-right">
          ${this.ctx.isDesktopApp ? '' : `<div class="download-wrapper" id="downloadWrapper">
            ...
            <div class="download-dropdown cy-panel cy-popup" id="downloadDropdown"></div>
          </div>`}
      ...
      <div class="main-content">
        <div class="map-section" id="mapSection">
          <div class="panel-header cy-panel-header">
            <div class="panel-header-left">
              <span class="panel-title cy-panel-title">${SITE_VARIANT === 'tech' ? t('panels.techMap') : SITE_VARIANT === 'happy' ? 'Good News Map' : t('panels.map')}</span>
            </div>
  ...
  private createPanels(): void {
    ...
    for (const key of Object.keys(FEEDS)) {
      ...
      const panelConfig = getDefaultPanels()[panelKey] ?? getDefaultPanels()[key];
    ...
    const defaultOrder = Object.keys(getDefaultPanels()).filter(k => k !== 'map');
